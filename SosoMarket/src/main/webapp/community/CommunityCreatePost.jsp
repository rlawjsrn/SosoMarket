...
<div class="section">
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                <form action="/SosoMarket/CommunityCreatePost.do" method="post" class="d-flex align-items-baseline">
                    <label for="postTitle">제목:</label>
                    <input type="text" id="postTitle" name="postTitle" class="input" placeholder="게시글 제목을 입력해주세요." required>
                    <br>
                    <br>
                    ...
                    <br>
                    <br>
                    <input type="submit" value="게시글 등록" class="primary-btn order-submit">
                    &nbsp;<a href="/SosoMarket/CommunityPostList.do" class="primary-btn order-submit">뒤로 가기</a>
                </form>
