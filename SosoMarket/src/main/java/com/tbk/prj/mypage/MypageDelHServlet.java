 ...
 */
@WebServlet("/MypageDelH.do")
public class MypageDelHServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageDelHServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		vo.setProductInterestId(request.getParameter("row"));
		int n = dao.delHeart(vo);
		// 목록을 보여줄 페이지
		String viewPage = "/MypageLikeList.do";
